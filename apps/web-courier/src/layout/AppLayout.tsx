...
export function AppLayout({ children }: PropsWithChildren) {
  ...
  return (
    <div className="min-h-screen text-slate-900">
      <div className="pointer-events-none fixed inset-x-0 top-0 z-0 h-72 bg-gradient-to-b from-sky-100/50 via-white/0 to-transparent" />
      <header className="sticky top-0 z-40 border-b border-white/70 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          <div>
            <h1 className="text-lg font-bold tracking-tight text-slate-900">FOODO Courier</h1>
